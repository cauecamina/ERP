...
export class AddShowImageToProduct1771900738803 implements MigrationInterface {
    name = 'AddShowImageToProduct1771900738803'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`show_image\` tinyint NOT NULL DEFAULT 1`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`show_image\``);
    }
